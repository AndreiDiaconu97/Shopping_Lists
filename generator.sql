...
INSERT INTO REG_USERS(email, password, firstname, lastname, is_admin, avatar) VALUES ('andrea.matte@studenti.unitn.it', 'password', 'andrea', 'mattè', TRUE, NULL);
INSErT INTO LISTS_CATEGORIES VALUES ('alimenti', 'cibo man', NULL);
INSERT INTO LISTS(name, description, category, owner, logo) VALUES ('lista1', 'descrizione', 'alimenti', 1, NULL);
INSERT INTO LISTS_SHARING VALUES (1, 1);

    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println(
                    ...
                    + "<html>\n"
                    + "    <head>\n"
                    + "        <title>Lab 07: Shopping lists shared with " + reg_user.getFirstname() + "</title>\n"
                    ...
                    + "                    </div>\n"
                    + "                    <div class=\"card-body\">\n"
                    + "                        The following table lists all the shopping-lists shared with &quot;" + reg_user.getFirstname() + "&quot;.<br>\n"
                    + "                    </div>\n"
                    + "\n"

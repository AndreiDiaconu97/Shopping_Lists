 ...
 * @param <PRIMARY_KEY_CLASS> the class of the primary key of the entity the dao handle.
 *
...
public abstract class JDBC_DAO<ENTITY_CLASS, PRIMARY_KEY_CLASS> implements DAO<ENTITY_CLASS, PRIMARY_KEY_CLASS> {
    ...
    /**
     * If this DAO can interact with it, then returns the DAO of class passed as parameter.
     *
     * @param <DAO_CLASS> the class name of the DAO that can interact with this DAO.
     * @param daoClass the class of the DAO that can interact with this DAO.
     * @return the instance of the DAO or null if no DAO of the type passed as parameter can interact with this DAO.

...
int main() {
	...
	output << "\n\n\n\n\n";
	output << logos["users"];
	output << "INSERT INTO APP.REG_USERS (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,IS_ADMIN,AVATAR) VALUES ('andrea.matte@studenti.unitn.it','$2a$10$zmo44mIGrEzF.2flUu13SOatFYW8LHaRoxSGPJeRRM.fe6IBfddCS','andrea','matto',false,NULL);\n";
	output << "INSERT INTO APP.REG_USERS (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,IS_ADMIN,AVATAR) VALUES ('andrei.diaconu@studenti.unitn.it','$2a$10$bek3pnCbDuA7YfLXHDpVi./CPITBTv.nPud1Q63WukdgtKsrr.NCe','andrei','kontorto',false,NULL);\n";
	output << "INSERT INTO APP.REG_USERS (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,IS_ADMIN,AVATAR) VALUES ('andrea.iossa@studenti.unitn.it','$2a$10$N9qdvU/PSaRyeaQbq8L7N.dOoZARRBCNmJc0puH3amiteKiuI7U9y','andrea','ioza',false,NULL);\n";
	// altri utenti random
	...
	for(int i=3; i<TOT_USERS; i++){
		...
		output << "INSERT INTO APP.REG_USERS (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,IS_ADMIN,AVATAR) VALUES ('" << name << "." << lastname << (31*i) << domain << "','$2y$10$4g/8zymTLbHTZJYT.44EDuMqAgDi.0v1/mjCLPABn1WakOUIfz.Ee','" << name << "','" << lastname << "',false,NULL);\n";
	}
	output << "\n\n\n\n\n";
	////////////////////////////////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for(pair<Category, vector<Product>> c_vp : categ_prod){
		...
		for(Product p : c_vp.second){
			...
			output << "'" << p[0] << "','" << p[1] << "','" << p[2] << "',1,TRUE,NULL,NULL);\n";
		}
		output << endl;
	}
	output << "\n\n\n";
	...
	for(int i=1; i<=LIST_NUM; i++){
		...
		for(int u=1; u<=amount; u++){
			output << "INSERT INTO APP.LISTS_SHARING (LIST,REG_USER) VALUES (" << i << "," << (rand()%TOT_USERS +1) << ");\n";
		}
	}
	output << "\n\n\n\n";
